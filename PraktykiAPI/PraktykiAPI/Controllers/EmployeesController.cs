...
namespace PraktykiAPI.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetEmployeeDaysOff(DateOnly date)
        {
            ...
            var employee = await _context.Employees.Where(e => _context.Days_Off.Any(d => d.Employee_ID == e.ID && date >= d.Start_Date && date <= d.End_Date && d.Status == "Accepted")).Select(e => new {e.Name, e.Surname}).ToListAsync();
